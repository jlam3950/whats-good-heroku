...
const Contact = () => {
  return (
    <div className="relative flex items-top justify-center min-h-screen  dark:bg-gray-900 sm:items-center sm:pt-0">
        <div className="max-w-6xl mx-auto  md:mb-64 sm:px-6 lg:px-8">
            <div className="mt-8 overflow-hidden">
                <div className="grid grid-cols-1 md:grid-cols-2">
                    <div className="p-6 mr-2 mb-8 dark:bg-gray-800 sm:rounded-lg">
                        <h1 className="text-3xl sm:text-5xl text-gray-800 dark:text-white font-extrabold tracking-tight animate-fade-in-down">
                            Get in touch
                        </h1>
                        <p className="text-normal text-lg sm:text-xl font-medium  dark:text-gray-400 mt-2">
                        ...
                        <div className="flex items-center mt-4 dark:text-gray-400">
                            <svg fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" viewBox="0 0 24 24" className="w-8 h-8 text-gray-500">
